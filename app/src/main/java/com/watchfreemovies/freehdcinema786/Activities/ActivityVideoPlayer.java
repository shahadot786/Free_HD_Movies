...
public class ActivityVideoPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (UiConfig.FORCE_VIDEO_PLAYER_TO_LANDSCAPE) {
    ...
    public void errorDialog() {
        new AlertDialog.Builder(this, R.style.AppCompatAlertDialogStyle)
                ...
                .setTitle("Oops!")
                .setCancelable(false)
                .setMessage("Failed to load stream, probably the stream server currently down! Retry or Try another server Or Download Movie!!")
