...
public class AdapterVideo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case VIEW_AD:
                View adItemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.lsv_item_video_ad, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (viewType) {
            ...
            case VIEW_AD:
                ...
                ad_holder.category.setText(Html.fromHtml(ad_item.category_name));
